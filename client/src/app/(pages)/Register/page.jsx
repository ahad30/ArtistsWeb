...
const Register = () => {
  ...
  console.log("nice one bruh", register);
  ...
  useEffect(() => {
    if (lIsSuccess) {
      toast.success("Registration Successful please check your mobile for passcode and login", { id: 1 , duration: 10000 });
      router.push("/Login");
  ...
  // console.log("hello tryanother",countryOptions)
